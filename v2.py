...
block_size = 32 # what is the max context length for predictions?
max_iters = 5000
eval_interval = 100
learning_rate = 1e-3
...
class Block(nn.Module):
  ...
  def __init__(self, n_embd, n_head):
    # n_embd: embedding dimenstion, n_head: the no of heads we'd like
    super().__init__()
...
class BigramLanguageModel(nn.Module):
  ...
  def forward(self, idx, targets=None):
    B,T = idx.shape
    # idx and targets for both (B,T) tensor of integers
